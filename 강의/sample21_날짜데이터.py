...
print("1.현재날짜 :", datetime.now())   #2023-06-05 16:10:56.855297
print("1.현재날짜 :", datetime.today()) #2023-06-05 16:10:56.855297
...
# 특정날짜 생성
new_date = datetime(2022,5,19) # datetime 생성 (년, 월, 일은 필수 값)
